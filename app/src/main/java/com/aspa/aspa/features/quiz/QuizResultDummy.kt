    ...
    companion object {
        val dummyQuizResult1 = listOf(
            Quiz(
                ...
                options = listOf("useEffect", "useState", "useContext", "useReducer"),
                answer = "useState",
                chosen = "useState",
            ...
            Quiz(
                ...
                options = listOf("var", "let", "const", "define"),
                answer = "define",
                chosen = "var",
            ...
            Quiz(
                ...
                options = listOf("let arr = []", "let arr = {}", "let arr = ()", "let arr = <>"),
                answer = "let arr = []",
                chosen = "let arr = {}",
        ...
        val dummyQuizResult2 = listOf(
            Quiz(
                ...
                options = listOf("function", "def", "lambda", "proc"),
                answer = "function",
                chosen = "function",
            ...
            Quiz(
                ...
                options = listOf("string", "number", "boolean", "character"),
                answer = "character",
                chosen = "boolean",
            ...
            Quiz(
                ...
                options = listOf("값과 타입을 모두 비교", "값만 비교", "타입만 비교", "값과 메모리 위치 비교"),
                answer = "값과 타입을 모두 비교",
                chosen = "값만 비교",
        ...
        val dummyQuizResult3 = listOf(
            Quiz(
                ...
                options = listOf("pop()", "shift()", "remove()", "delete()"),
                answer = "pop()",
                chosen = "shift()",
            ...
            Quiz(
                ...
                options = listOf("Promise", "Future", "Task", "Coroutine"),
                answer = "Promise",
                chosen = "Task",
            ...
            Quiz(
                ...
                options = listOf("for...in", "for...of", "forEach", "while"),
                answer = "for...in",
                chosen = "forEach",
            ...
            Quiz(
                ...
                options = listOf("addEventListener", "attachEvent", "onEvent", "bindEvent"),
