    ...
    sections = listOf(
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("JavaScript를 빠르게 실행하기 위해", "HTML을 데이터로 다루기 위해", "UI를 선언적으로 표현하기 위해", "CSS를 더 쉽게 작성하기 위해"),
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("이벤트 전달", "상태 저장", "부모로부터 받은 데이터", "렌더링 최적화"),
                answer = "부모로부터 받은 데이터",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("전역 상태 관리", "비동기 처리", "로컬 상태 저장", "데이터 바인딩"),
                answer = "로컬 상태 저장",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("렌더링 제어", "이벤트 리스너 생성", "사이드 이펙트 처리", "상태 초기화"),
                answer = "사이드 이펙트 처리",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("성능 향상", "데이터 전역 공유", "코드 분리", "컴포넌트 수명 연장"),
                answer = "데이터 전역 공유",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("코드 보안 강화", "코드 재사용성 향상", "렌더링 속도 향상", "JSX 사용 단순화"),
                answer = "코드 재사용성 향상",
    ...
    sections = listOf(
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("조건부 렌더링", "반복 렌더링", "스타일 적용", "이벤트 바인딩"),
                answer = "반복 렌더링",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("자식에서 부모로 데이터 전달", "컴포넌트 간 이벤트 공유", "부모에서 자식으로 데이터 전달", "상태 저장"),
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("ref는 객체 전용", "reactive는 기본형 전용", "ref는 기본형, reactive는 객체", "둘 다 동일"),
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("컴포넌트 생성 직후", "DOM 렌더링 완료 후", "컴포넌트 제거 전", "데이터 변경 시"),
                answer = "DOM 렌더링 완료 후",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("글로벌 상태 공유", "상위-하위 간 데이터 전달", "컴포넌트 재사용", "템플릿 최적화"),
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("렌더링 제어", "템플릿 연결", "반응형 로직 정의", "스타일 구성"),
                answer = "반응형 로직 정의",
    ...
    sections = listOf(
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("둘 다 수정 가능", "val은 수정 가능, var은 불가능", "val은 불변, var은 가변", "모두 불변"),
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("예외 처리", "조건 분기", "반복 처리", "클래스 선언"),
                answer = "조건 분기",
        ...
        Section(
            ...
            quiz = Quiz(
                question = "람다식의 특징은?",
                options = listOf("이름이 필요함", "여러 줄만 가능", "익명 함수", "클래스에서만 사용 가능"),
                answer = "익명 함수",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("inherit", "extends", "open", "super"),
                answer = "open",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("불변 리스트", "가변 리스트", "정렬 리스트", "null 리스트"),
                answer = "가변 리스트",
        ...
        Section(
            ...
            quiz = Quiz(
                ...
                options = listOf("데이터 저장 함수", "UI를 구성하는 함수", "백엔드 연결 함수", "상태 저장 함수"),
                answer = "UI를 구성하는 함수",
